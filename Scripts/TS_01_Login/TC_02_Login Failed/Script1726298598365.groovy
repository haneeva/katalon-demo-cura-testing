...
WebUI.setText(findTestObject('Object Repository/TOR_01_Login/Page_CURAHealthcareService/input_Username'), username)
...
try {
	...
	if(username == null && password == null) {
		WebUI.verifyElementPresent(findTestObject('Object Repository/TOR_01_Login/Page_CURAHealthcareService/alert_LoginFailed'), 5)
		
		String errorMessage = WebUI.getText(findTestObject('Object Repository/TOR_01_Login/Page_CURAHealthcareService/alert_LoginFailed'))
		WebUI.comment('Login was failed and error message was displayed: ' + errorMessage)
		...
		WebUI.comment('A different error message was displayed')
	}
} catch (Exception e) {
	WebUI.comment('An exception occurred: ' + e.getMessage())
    return
}
